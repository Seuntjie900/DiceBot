    ...
    class PRC:DiceSite
    {
        ...
        public override void ResetSeed()
        {
            ...
            try
            {
                ...
                PRCResetSeed tmp = Helpers.json.JsonDeserialize<PRCResetSeed>(s1);
                if (tmp.Success)
                {
        ...
        public override void Login(string Username, string Password, string twofa)
        {
            ...
            try
            {
                ...
                Response = (HttpWebResponse)getHeaders.GetResponse();
                s1 = new StreamReader(Response.GetResponseStream()).ReadToEnd();
                PRCUser tmp = Helpers.json.JsonDeserialize<PRCUser>(s1);
                ...
                Response = (HttpWebResponse)getHeaders.GetResponse();
                s1 = new StreamReader(Response.GetResponseStream()).ReadToEnd();
                prcSeed getseed = Helpers.json.JsonDeserialize<prcSeed>(s1);
                ...
                try
                {
                    ...
                    Response = (HttpWebResponse)getHeaders.GetResponse();
                    s1 = new StreamReader(Response.GetResponseStream()).ReadToEnd();
                    PRCDepost dep = Helpers.json.JsonDeserialize<PRCDepost>(s1);
