    ...
    class dice999:DiceSite
    {
        ...
        void GetBalance()
        {
            if (sessionCookie != "" && sessionCookie != null && (DateTime.Now - Lastbalance).TotalSeconds>60)
            {
                ...
                balance = (double)Helpers.json.JsonDeserialize<d999Login>(responseData).Balance / 100000000.0;
                if (balance == 0)
                {
            ...
            try
            {
                ...
                if (next == "" && next!=null)
                {
                   ...
                   Content = new FormUrlEncodedContent(pairs);
                    ...
                    string Hash = next = Helpers.json.JsonDeserialize<d999Hash>(responseData).Hash;
                }
                ...
                d999Bet tmpBet =Helpers.json.JsonDeserialize<d999Bet>(responseData);
                ...
                else
                {
                    ...
                    tmp.Chance = (chance * 100.0) / 999999.0;
                    tmp.ClientSeed = ClientSeed;
                    tmp.Currency = Currency;
                    tmp.High = High;
                    tmp.ID = tmpBet.BetId;
                    tmp.Nonce = 0;
                    tmp.Profit = ((double)tmpBet.PayOut / 100000000.0) - (amount);
                    tmp.Roll = (double)tmpBet.Secret / 10000.0;
                    tmp.ServerHash = next;
                    ...
                    bool win = false;
                    if ((tmp.Roll > (99.99 - tmp.Chance) && High) || (tmp.Roll < tmp.Chance && !High))
                    {
                        win = true;
                    }
                    if (win)
        ...
        public override void Login(string Username, string Password, string twofa)
        {
            ...
            d999Login tmpU =Helpers.json.JsonDeserialize<d999Login>(responseData);
        ...
        public override bool Register(string username, string password)
        {
            ...
            d999Register tmp =Helpers.json.JsonDeserialize<d999Register>(responseData);
        ...
        public void GetDepositAddress()
        {
            if (sessionCookie != "" && sessionCookie != null)
            {
                ...
                d999deposit tmp =Helpers.json.JsonDeserialize<d999deposit>(responseData);
