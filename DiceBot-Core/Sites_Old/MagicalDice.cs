...
namespace DiceBotCore.Sites_Old
{
    class MagicalDice: DiceSite
    {
        ...
        void PlaceBetThread(object Bool)
        {
            try
            {
                ...
                try
                {
                    ...
                    MDBet tmp = Helpers.json.JsonDeserialize<MDBet>(sEmitResponse);
                    if (tmp.error == 0)
                    {
                        Bet tmp2 = tmp.ToBet();
        ...
        protected override bool internalWithdraw(double Amount, string Address)
        {
            ...
            MDCsrf tmp = Helpers.json.JsonDeserialize<MDCsrf>(s1);
        ...
        public override void Login(string Username, string Password, string twofa)
        {
            ...
            try
            {
                ...
                MDAuthKey au = Helpers.json.JsonDeserialize<MDAuthKey>(s1);
                //set auth key
                authkey = au.auth_key;
                //get user stats
    ...
    public class MDBet
    {
        ...
        public Bet ToBet()
        {
            ...
            Bet tmp = new Bet {
            Amount= (bet_amount / 100000000.0),
            Date = DateTime.Parse(bet_time),
            ID = long.Parse(bet_id),
            Profit = (bet_profit/100000000.0),
            Roll = (double)bet_roll,
            ...
            tmp.Chance = (double)(tmp.High ? 99.99m - tchance : tchance);
            return tmp;
        }
    }
    public class MDCsrf
