       ...
       protected int appid = 492;
            ...
            while (ismp)
            {
                if (token != "" && token != null && (DateTime.Now-lastupdate).TotalSeconds > 30)
                {
                    ...
                    try
                    {
                        ...
                        MPAuth tmp2 = Helpers.json.JsonDeserialize<MPAuth>(s);
        ...
        void placebetthread(object _High)
        {
            ...
            try
            {
                ...
                HttpContent cont = new StringContent(Helpers.json.JsonSerializer<MPBetPlace>(betplace));
                ...
                MPBet tmp = Helpers.json.JsonDeserialize<MPBet>(Resp);
                if (tmp.error != null)
                {
        ...
        public override void ResetSeed()
        {
            ...
            MPSeed tmp = Helpers.json.JsonDeserialize<MPSeed>(res);
            next = tmp.hash;
        }
