...
namespace DiceBot
{
    ...
    void setInterval(System.Windows.Forms.Timer tmr, int Interval)
    {
        ...
        private void martingaleCalculatorToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Form MartingaleCalculator = new MartingaleCalculator();
            MartingaleCalculator.Show();
        }
