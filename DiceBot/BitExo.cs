...
namespace DiceBot
{
    ...
    (sender, cert, chain, sslPolicyErrors) => true;
        ...
        void ProcessBalance(string Res)
        {
            ...
            {
                case "btc":balance = tmpResult.user.balances.btc/100000000m;
                    ...
                    break;
                case "bxo": balance = tmpResult.user.balances.bxo / 100000000m;
                    ...
                    break;
                case "clam": balance = tmpResult.user.balances.clam / 100000000m;
                    ...
                    break;
                case "doge": balance = tmpResult.user.balances.doge / 100000000m;
                    ...
                    break;
                case "eth": balance = tmpResult.user.balances.eth / 100000000m;
                    ...
                    break;
                case "flash": balance = tmpResult.user.balances.flash / 100000000m;
                    ...
                    break;
                case "ltc": balance = tmpResult.user.balances.ltc / 100000000m;
