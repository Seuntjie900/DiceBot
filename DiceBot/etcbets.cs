...
namespace DiceBot
{
    public class etcbets : DiceSite
    {
        ...
        public etcbets(cDiceBot Parent)
        {
            ...
            ChangeSeed = true;
            AutoLogin = false;
            BetURL = "https://etcbets.com/api/bet/id?=";
            this.Parent = Parent;
            Name = "EtcBets";
            Tip = true;
            TipUsingName = true;
            SiteURL = "https://etcbets.com/?ref=1304270";
    ...
    {  
        ...
        public override bool Register(string Username, string Password)
        {
            ...
            if (System.Windows.Forms.MessageBox.Show("Unfortunately DiceBot cannot register new users at etcbets.com. Want to open the page now?", "Register", System.Windows.Forms.MessageBoxButtons.YesNo) == System.Windows.Forms.DialogResult.Yes)
            {
                System.Diagnostics.Process.Start("https://etcbets.com/?ref=1301492");
            }
        ...
        public override void Login(string Username, string Password, string otp)
        {
            ...
            Client = new HttpClient(ClientHandlr) { BaseAddress = new Uri("https://etcbets.com/api/") };
        ...
        void placebetthread(object BetObj)
        {
            try
            {
                ...
                FormUrlEncodedContent Content = new FormUrlEncodedContent(pairs);
                string responseData = "";
                string z = Content.ToString();
                string y = Content.ReadAsStringAsync().Result;
        ...
        public override bool InternalSendTip(string User, decimal amount)
        {
            ...
            try
            {
                ...
                HttpWebRequest loginrequest = (HttpWebRequest)HttpWebRequest.Create("https://etcbets.com/api/api/tip");
                if (Prox != null)
